<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SultryShots.Default" %>
...
<div id="footerbox">
<br><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>&copy; <?php print(Date("Y")); ?><%=DateTime.Now.ToString() %> Alberto Leopizzi&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Web Services by <a href="mailto:diamondsoftware222@gmail.com">Diamond Software</a>
</body>
</html>
